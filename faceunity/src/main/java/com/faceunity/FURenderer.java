...
public class FURenderer implements OnFUControlListener {
    ...
    public volatile static float mFilterLevel = 1.0f;//滤镜强度
    public volatile static float mSkinDetect = 1.0f;//肤色检测开关
    public volatile static float mBlurLevel = 0.7f;//磨皮程度
    public volatile static float mBlurType = 0.0f;//磨皮类型
    public volatile static float mColorLevel = 0.3f;//美白
    public volatile static float mRedLevel = 0.3f;//红润
    public volatile static float mEyeBright = 0.0f;//亮眼
    public volatile static float mToothWhiten = 0.0f;//美牙
    public volatile static float mFaceShape = BeautificationParam.FACE_SHAPE_CUSTOM;//脸型
    public volatile static float mFaceShapeLevel = 1.0f;//程度
    public volatile static float mCheekThinning = 0f;//瘦脸
    public volatile static float mCheekV = 0.5f;//V脸
    public volatile static float mCheekNarrow = 0f;//窄脸
    public volatile static float mCheekSmall = 0f;//小脸
    public volatile static float mEyeEnlarging = 0.4f;//大眼
    public volatile static float mIntensityChin = 0.3f;//下巴
    public volatile static float mIntensityForehead = 0.3f;//额头
    public volatile static float mIntensityMouth = 0.4f;//嘴形
    public volatile static float mIntensityNose = 0.5f;//瘦鼻

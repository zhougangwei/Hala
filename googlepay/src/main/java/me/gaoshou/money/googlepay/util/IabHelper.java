...
package me.gaoshou.money.googlepay.util;
...
public class IabHelper {
    ...
    private boolean bindServiceFailed;
    ...
    public void dispose() throws IabAsyncInProgressException {
        ...
        if (mServiceConn != null) {
            ...
            if (mContext != null&&!bindServiceFailed )
            {
    ...
    void logError(String msg) {
        LogUtils.e(mDebugTag, "In-app billing error: " + msg);
    }

...
public class WorkerThread extends Thread {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case ACTION_WORKER_CONNECT_TO_RTM_SERVICE:
                    data = (String[]) msg.obj;
                    mWorkerThread.connectToRtmService(data[0],data[1]);
                    break;
    ...
    public final void joinChannel(String mediaToken, final String channel, int uid) {
        if (Thread.currentThread() != this) {
            ...
            envelop.obj = new String[]{mediaToken,channel};
            envelop.arg1 = uid;
            mWorkerHandler.sendMessage(envelop);
            return;
        }
        ...
        ensureRtmClientReadyLock();
        ensureRtcEngineReadyLock();
        mRtcEngine.joinChannel(mediaToken, channel, "OpenDuo", uid);

...
public class LoginActivityOld extends BaseActivity implements IdViewListener {
    ...
    private void loginfacebook() {
        ...
        facebookLoginManager.loginFaceBook(this, new FacebookLoginManager.OnResult() {
            ...
            @Override
            public void fail() {
                ToastUtils.showToast(LoginActivityOld.this, getString(R.string.login_failed));

            }

            @Override
            public void regist(String id) {
                Intent intent = new Intent(LoginActivityOld.this, EditProUserActivity.class);
